        ...
        <form method="post" action="{{ route('pesanan.update', $pesanans->id) }}">
            ...
            <div class="form-row">
                <div class="col-md-3 mb-3 input-group-sm">
                    <label>ID</label>
                    <input type="text" name="id" class="form-control" placeholder="" required="" value="{{ old('id', $pesanans->id) }}" disabled>
                </div>
                <div class="col-md-3 mb-3 input-group-sm">
                    <label>Produk</label>
                ...
                <div class="col-md-3 mb-3 input-group-sm">
                    ...
                    <input type="text" name="jml_kaos" class="form-control" placeholder="" required="" value="{{ old('jml_kaos', $pesanans->jml_kaos) }}">
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-4 mb-3 input-group-sm">
                    ...
                    <input type="text" name="kain" class="form-control" placeholder="" required="" value="{{ old('jml_kaos', $pesanans->kain) }}">
                </div>
                <div class="col-md-4 mb-3 input-group-sm">
                    </br>
                    <label>Jumlah Benang (Yard)</label>
                    <input type="text" name="benang" class="form-control" placeholder="" required="" value="{{ old('jml_kaos', $pesanans->benang) }}">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group text-left col-md-6 mb-3">
                    <br>
                    <button type="submit" class="editbtn btn btn-primary left-block"><i class="fa fa-save"></i> Simpan Perubahan</button>
                </div>
            </div>
        </form>
        <div class="col-sm-12">
