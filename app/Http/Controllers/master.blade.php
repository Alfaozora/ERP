    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('home')}}"><span>SPK</span> Desa Gedongboyountung</a>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                    <em class="fa fa-id-card-o">&nbsp;</em> Alternatif <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-1">
                    <li><a class="" href="{{route('tampilwarga')}}">
                            <span class="fa fa-arrow-right">&nbsp;</span> Data Warga
                        </a></li>
                    <li><a class="" href="#">
                            <span class="fa fa-arrow-right">&nbsp;</span> Nilai Alternatif
                        </a></li>

                </ul>
            </li>
            <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                    <em class="fa fa-bar-chart" aria-hidden="true">&nbsp;</em> Kriteria <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-2">
                    <li><a class="" href="{{route('tampilkriteria')}}">
                            <span class="fa fa-arrow-right">&nbsp;</span> Nilai Kriteria
                        </a></li>
                </ul>
            </li>
            <li><a href="#"><em class="fa fa-calculator">&nbsp;</em> Penilaian</a></li>
            <li><a href="{{route('about')}}"><em class="fa fa-info">&nbsp;</em> About</a></li>
                ...
                <div class="col-sm-5 col-md-6">
                    <div class="panel panel-teal panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
                            <div class="large">{{$warga}}</div>
                            <div class="text-muted">Pendaftar Penerima Bantuan</div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-5 col-sm-offset-2 col-md-6 col-md-offset-0">
                    <div class="panel panel-blue panel-widget border-right">
                        <div class="row no-padding"><em class="fa fa-xl fa-handshake-o color-orange"></em>
                            <div class="large">#</div>
                            <div class="text-muted">Penduduk Mendapat Bantuan</div>
                        </div>
                    </div>
                </div>
            </div>
